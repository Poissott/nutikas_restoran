...
function RestaurantGraphic({ stageWidth, stageHeight }: RestaurantGraphicProps) {
  ...
  return (
    <Layer>
        ...
        <Line points={[roomX + roomWidth, roomY, roomX + roomWidth, roomY + s(325)]} stroke="#1f2937" strokeWidth={s(3)} lineCap="round" />

        {/* Exit */}
        <Line
          points={[roomX + roomWidth, roomY + s(325), roomX + roomWidth, roomY + roomHeight]}
          stroke="#1f2937"
          strokeWidth={s(2)}
          dash={[s(8), s(4)]}
        />
        <Line points={[roomX + roomWidth, roomY + s(325), roomX + roomWidth - s(60), roomY + s(350)]} stroke="#1f2937" strokeWidth={s(2)} />
        <Text text="Exit" x={roomX + roomWidth - s(45)} y={roomY + s(360)} fontSize={s(16)} fill="#1f2937" />
        ...
        {/* Play area */}
        <Rect x={roomX + s(200)} y={roomY + s(10)} width={s(100)} height={s(80)} fill="#c4b5fd" opacity={0.75} cornerRadius={s(8)} stroke="#312e81" strokeWidth={s(1.5)} />
        <Text text="Play Area" x={roomX + s(208)} y={roomY + s(40)} fontSize={s(16)} fill="#312e81" />

        {/* Counter */}
        <Rect x={roomX + s(30)} y={roomY + roomHeight - s(55)} width={s(400)} height={s(50)} fill="#d1d5db" cornerRadius={s(7)} stroke="#4b5563" strokeWidth={s(1.5)} />
        <Text text="Counter" x={roomX + s(200)} y={roomY + roomHeight - s(39)} fontSize={s(18)} fill="#1f2937" />
    </Layer>
  );
}
